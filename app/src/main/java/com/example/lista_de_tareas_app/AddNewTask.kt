...
class AddNewTask : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val buttonColor = if (hasText) ContextCompat.getColor(requireContext(), R.color.colorPrimaryDark)
        ...
        newTaskText.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                ...
                val color = if (hasText) ContextCompat.getColor(requireContext(), R.color.colorPrimaryDark)
                else ContextCompat.getColor(requireContext(), android.R.color.darker_gray)
